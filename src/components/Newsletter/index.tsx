...
export default function Newsletter() {
   ...
   return (
      <>
         <form onSubmit={handleSubmit} id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="">
            <p className="uppercase tracking-widest mb-2 font-medium">Stay Updated</p>
            <div className="flex">
               <input
                  type="email"
                  name="EMAIL"
                  ...
                  className="flex-1 bg-white/8 border border-white/10 text-white placeholder-stone-400 px-3 py-2.5 rounded-l-md outline-none focus:bg-black/10 border-r-0"
               />
               ...
               <input
                  ...
                  value={status === "loading" ? "Subscribing…" : "Join"}
                  disabled={status === "loading"}
                  className="px-4 py-2.5 font-medium text-white rounded-r-md hover:opacity-90 transition-opacity whitespace-nowrap bg-primary"
               />
            </div>
            {status === "error" && (
      ...
      //       className="flex flex-col gap-4 lg:w-2/3 bg-black-forground p-4 rounded-md"
      //    >
      ...
      //          value={email}
      //          onChange={(e) => setEmail(e.target.value)}
      //          className="border border-neutral-700 rounded-lg p-2 placeholder:text-neutral-500 text-white focus:bg-neutral-900"
      //       />
