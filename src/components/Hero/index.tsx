...
export default function Hero() {
   return (
      <section className="md:h-[86vh] flex justify-center items-center bg-navy_blue py-12">
         <div className="max-w-7xl mx-auto px-4 md:px-0 z-20">
            <div className="grid lg:grid-cols-[1.5fr_1fr] gap-14 items-center text-white ">
               <div className="space-y-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                     ...
                     <Link
                        href="/our-factory"
                        className="flex items-center gap-2 px-7 py-3.5 rounded-[7px] text-sm font-medium border border-primary text-primary hover:bg-neutral-100/10 duration-300"
                     >
