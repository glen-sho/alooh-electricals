// ── Constants ────────────────────────────────────────────────────
export const WA_NUMBER = "+233532830714";
...
export const products: DisplayProductsType[] = [
   ...
   },
   {
      ...
      images: ["neworient-double-socket-white.png", "neworient-double-socket-ash.png"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["single-socket-white.png", "single-socket-ash.png"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["1-gang-switch-ash.png", "1-gang-switch-white.png"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["1-gang-switch-white.png", "1-gang-switch-ash.png"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["2-gang-switch-ash.png", "2-gang-switch-white.png"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["3-gang-switch-white.png", "3-gang-switch-ash.png"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["heater.png", "heater-silver.png"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["tv-switch-white.png", "tv-switch-ash.png"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["havells-12-way-single-phase.png"],
      brand: brands.havells,
      description:
   ...
   },
   {
      ...
      images: ["extension-board-5-slots.png"],
      brand: brands.generic,
      description:
   ...
   },
   {
      ...
      images: ["extension-board-3-slots.png"],
      brand: brands.generic,
      description:
   ...
   },
   {
      ...
      images: ["2.5-x-3c-flexible-cable.png"],
      brand: brands.turkey,
      description:
   ...
   },
   {
      ...
      images: ["2.5-x-4c-flexible-cable.png"],
      brand: brands.turkey,
      description:
   ...
   },
   {
      ...
      images: ["4-x-3c-flexible-cable.png"],
      brand: brands.turkey,
      description:
   ...
   },
   {
      ...
      images: ["4.0-x-4c-flexible-cable.png"],
      brand: brands.turkey,
      description:
   ...
   },
   {
      ...
      images: ["6.0-x-4c-flexible-cable.png"],
      brand: brands.generic,
      description:
