...
export const products: DisplayProductsType[] = [
   ...
   },
   {
      ...
      images: ["neworient-double-socket-white.jpg", "neworient-double-socket-ash.jpg"],
      brand: brands.neworient,
      description:
   ...
   },
   {
      ...
      images: ["https://drive.google.com/file/d/1aQaagqYV5f7jFmjuJQ9Jl9zbSNeqw_q7/view?usp=drive_link"],
      brand: brands.havells,
      description:
   ...
   },
   {
      ...
      images: ["https://drive.google.com/file/d/1biMYBUOP0BknPcwI2XK7naKDLYSDhl6y/view?usp=drive_link"],
      brand: brands.havells,
      description:
   ...
   },
   {
      ...
      images: ["https://drive.google.com/file/d/1ojyTm3vowwcvWcINpLiBifetumakFBSS/view?usp=drive_link"],
      brand: brands.havells,
      description:
   ...
   },
   {
      ...
      images: ["https://drive.google.com/file/d/1Jm40koU0MyXWMy_t5wwLR-fZarmIpzzF/view?usp=drive_link"],
      brand: brands.havells,
      description:
   ...
   },
   {
      ...
      images: ["https://drive.google.com/file/d/1gG49qyOhbZk8C57RL-LyILoGQ7jzVj0L/view?usp=drive_link"],
      brand: brands.generic,
      description:
   ...
   },
   {
      ...
      images: ["https://drive.google.com/file/d/1Ay00kD3CqrofzNgg9CfXkmEMWYAgI4QO/view?usp=drive_link"],
      brand: brands.generic,
      description:
   ...
   },
   {
      ...
      images: ["https://drive.google.com/file/d/12bGl5iKXQPSkxfQR1aVwwgbJMdM6fDS9/view?usp=drive_link"],
      brand: brands.generic,
      description:
   ...
   },
   {
      ...
      images: ["https://drive.google.com/file/d/1dFoaS5QnOgELiNEmv5Td2i1izi64rlQp/view?usp=drive_link"],
      brand: brands.generic,
      description:
